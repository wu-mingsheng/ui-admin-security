-- user
INSERT INTO user 
(username, password, creater_id, updater_id, state,create_time, update_time) 
VALUES ('admin','e10adc3949ba59abbe56e057f20f883e',10000, 10000, 'ENABLED', now(), now() ); 

-- role
INSERT INTO role (name,alias, creater_id, updater_id, state,create_time, update_time) 
VALUES 
('admin','管理角色', 10000, 10000, 'ENABLED', now(), now() );
